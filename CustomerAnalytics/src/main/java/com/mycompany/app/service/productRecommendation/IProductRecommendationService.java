...
//    List<ProductRecommendation> generateInvestmentRecommendations(String userId, List<FinancialPattern> patterns, List<AccountDto> accounts);
...
//    ProductRecommendation createInvestmentRecommendation(String userId, BigDecimal totalBalance);
...
//    void generateRecommendationForNewAccount(String userId, String accountType, BigDecimal balance);
